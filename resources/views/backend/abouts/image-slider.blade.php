...
@section('content')
                                    ...
                                    <tbody>
                                        @forelse ($aboutsImage  as $items)
                                            <tr class="about-image">
                                                ...
                                                <td><img src='{{ asset('assets/img/uploads/abouts/' . $items->image) }}'
                                                        width='120' height='120'></td>
                                                <td><a href="#"><i class="fas fa-upload fa-2x submit-id" data-toggle="modal"
                                                            data-target="#grid_modal"></i></a></td>
                                            </tr>
                                        @empty
    ...
    <div class="modal fade" id="grid_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="white_card_body">
                        <form action="{{ route('admin.about.slider.update') }}" id="about-slider" method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="card shadow-sm w-100">
                                                <div class="card-header d-flex justify-content-start">
                                                    ...
                                                    <a class="btn btn-sm btn-primary ml-4 " style="color:white;"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function getIdForModal(node) {
                let closest_div = $(node).closest('.about-image');
                let id = closest_div.find('.about-image-id').text();
                let mid = $('.modal-id').val(id);
            }
        });
    </script>
@endpush
