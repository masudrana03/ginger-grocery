        ...
        <div class="container-fluid white_card" id="printableArea" style="padding: 50px;">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <span>Phone: </span>{{ $order->user->phone_code }}{{ $order->user->phone }}<br>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <span>Phone: </span>{{ $order->shipping->phone_code }}{{ $order->shipping->phone }}<br>
                                ...
                                @foreach ($order->details as $item)
                                    <tr>
                                        <td class="px-0">
                                            ...
                                            href="#">{{ $item->product->store->name }}</a></small>

                                            {{-- <a href="{{ route('vendor.details', $item->product->store->slug) }}">{{ $item->product->store->name }}</a> --}}
                                        </td>
                                        <td class="px-0">
                                            {{ $item->quantity }}
                                        </td>
