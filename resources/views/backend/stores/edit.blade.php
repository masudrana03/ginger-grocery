                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" name="address"
                                                ...
                                                placeholder="Exp : 1255 Timbercrest Road">{{ old('address') }}</textarea>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" name="description"
                                                ...
                                                aria-describedby="emailHelp"
                                                placeholder="Exp : Got a smooth, buttery spread in your fridge? Chances are good that it's Good Chef.">{{ old('description') }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                        ...
                        <div class="white_card_body">
                            <form action="{{ route('admin.stores.update', $store->id) }}" method="POST"
                                    ...
                                    <select name="zone_id" id="choice_zones" onchange="get_zone_data(this.value)"
                                        ...
                                        @foreach ($zones as $zone)
                                            <option value="{{ $zone->id }}"
                                                {{ $zone->id == $store->zone_id ? 'selected' : '' }}>{{ $zone->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="">
                                    ...
                                    <select class="form-control" name="currency_id">
                                        @foreach ($currencies as $currency)
                                            <option {{ $currency->id == $store->currency_id ? 'selected' : '' }} value="{{ $currency->id }}">{{ $currency->code }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tax" id="longitude" class="form-control" id="longitude"
                                        aria-describedby="emailHelp" placeholder="" value="{{ $store->tax }}">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="white_card_body">
                            <div class="col-xl-12">
                                <div class="card_box box_shadow mb_30">
                                    ...
                                    <div class="col-md-12 map-warper" style="height: 450px;">
                                        <input id="pac-input" class="controls rounded" style="height: 3em; width: 230px;"
                                            type="text" placeholder="Search Your Zone" />
                                        <div id="map-canvas" style="height: 100%; margin:0px; padding: 0px;"></div>
                                    </div>
                                </div>
                            </div>
