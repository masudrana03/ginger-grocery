                ...
                <div class="col-xl-4 ">
                    <div class="white_card card_height_100 mb_30 sales_card_wrapper">
                        ...
                        <!-- <div class="media_thumb ml_25">
                            <img src="{{ asset('assets/img/plane_thumb.svg') }}" alt="">
                        </div> -->
                            ...
                            <div class="monthly_plan_wraper">
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="{{ asset('assets/img/crome.png') }}" alt="">
                                        </div>
                                        <div>
                                            <h5>Chrome Users</h5>
                                            <span>Today</span>
                                ...
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="{{ asset('assets/img/safari.png') }}" alt="">
                                        </div>
                                        <div>
                                            <h5>Chrome Users</h5>
                                            <span>Today</span>
                                ...
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="{{ asset('assets/img/OBJECTS.png') }}" alt="">
                                        </div>
                                        <div>
                                            <h5>Chrome Users</h5>
                                            <span>Today</span>
                            ...
                            <div class="todo_wrapper">
                                <div class="single_todo d-flex justify-content-between align-items-center">
                                    <div class="lodo_left d-flex align-items-center">
                                        ...
                                        <div class="todo_box">
                                            <label class="primary_checkbox  d-flex mr_10 ">
                                                <input type="checkbox">
                            ...
                            <div class="row height_100">
                                <div class="col-lg-6">
                                    ...
                                    <div class="weather_img_1 mt_30">
                                        <img class="img-fluid" src="{{ asset('assets/img/man.png') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="weather_img_2">
                                        <!-- <img class="img-fluid" src="{{ asset('assets/img/weather_1.png') }}" alt=""> -->
                                    </div>
                                </div>
                            </div>
                        </div>
