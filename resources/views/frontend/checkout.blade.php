                    ...
                    <div class="col-lg-6 mb-sm-15 mb-lg-0 mb-md-3">
                        <div class="toggle_info">
                            <span><i class="fi-rs-user mr-10"></i><span class="text-muted font-lg">Already have an
                                    account?</span> <a href="#loginform" data-bs-toggle="collapse" class="collapsed font-lg"
                    ...
                    <div class="table-responsive order_table checkout">
                        <table class="table no-border">
                            <tbody>
                                ...
                                <tr>
                                    <td class="image product-thumbnail"><img src="assets/imgs/shop/product-1-1.jpg" alt="#">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h4 class="text-brand">{{$product->currency->symbol}} {{$product->quantity * $product->price}}</h4>
                                    </td>
                                </tr>
                                @empty
