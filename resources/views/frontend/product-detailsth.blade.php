                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    ...
                                    <ul class="contact-infor mb-50">
                                        <li><img src="{{ asset('assets/frontend/imgs/theme/icons/icon-location.svg') }}"
                                                alt="" /><strong>Address: </strong> <span>{{ $product->store->address }},
                                                {{ $product->store->state }}, {{ $product->store->city }},
                                                {{ $product->store->zip }},
                                                {{ ucwords(strtolower(settings('country'))) }}</span></li>
                                ...
                                <div class="tab-pane fade" id="Reviews">
                                                                ...
                                                                <div class="desc">
                                                                    <div class="d-flex justify-content-between mb-10">
                                                                        <div class="d-flex align-items-center">
                                                                            <span
                                                                                class="font-xs text-muted">{{ $rating->created_at->diffForHumans() }}</span>
                                                                        </div>
                                                                        <div class="product-rate d-inline-block d-flex"
                                    ...
                                    <div class="comment-form">
                                        <form class="form-contact comment_form"
                                            action="{{ route('product.rating', $product->id) }}" method="post">
                                            @csrf
                                            ...
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    ...
                                                    <a aria-label="Add To Wishlist"
                                                        ...
                                                        class="action-btn small hover-up" tabindex="0"><i
                                                            class="fi-rs-heart"></i></a>
                                                            <a aria-label="Compare" data-id="{{ $product->id }}" class="action-btn compare-btn"
                                                                href="{{ route('compareProduct', $product->id) }}"><i
                                                                    class="fi-rs-shuffle"></i></a>
