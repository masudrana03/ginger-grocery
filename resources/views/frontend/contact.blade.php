                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="contact-from-area padding-20-row-col">
                                ...
                                <form action="{{ route('frontend.contact.massage') }}" method="POST" enctype="multipart/form-data" class="contact-form-style mt-30" id="contact-form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-style mb-20">
                                                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" placeholder="email" value="{{ old('email') }}">
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
