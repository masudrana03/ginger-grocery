                        ...
                        <div class="sidebar-widget-2 widget_search mb-50">
                            <div class="search-form">
                                <form action="#" method="GET">
                                    ...
                                    <input name="search" id="search-vendor" type="text"
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul class="sorting">
                                            ...
                                            <li><a class="sortById"
                                                    href="{{ url('/vendor-list?sort=total_items') }}"
                                            ...
                                            <ul class="contact-infor text-muted">
                                                <li><img src="{{ asset('assets/frontend/imgs/theme/icons/icon-location.svg') }}"
                                                    ...
                                                    <span>{{ $store->address }},<br>
                                                        ...
                                                        {{ $store->country->name }}</span>
                                                </li>
                                                <li><img src="{{ asset('assets/frontend/imgs/theme/icons/icon-contact.svg') }}"
                                                        alt="" /><strong>Call Us:</strong><span>
                                                        {{ $store->phone }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <a href="{{ route('vendor.details', $store->slug) }}"
                                            class="btn btn-xs">Visit
        ...
        $(document).ready(function() {
            ...
            $('#search-vendor').on('keyup', function() {
                ...
                if (search.length > 2) {
                    ...
                    $('#oldSearchVendor').html(loading);

                    var url = "{{ url('/vendor-list?name=') }}" + search;

                    setTimeout(function() {
                        $.ajax({
                            url: url,
                            success: function(response) {
                                $('#oldSearchVendor').empty();
                                $('#newSortDiv').empty();
                                $('#newSearchVendor').html(response);
                            }
                        });
                    }, 1500);
