                    ...
                    <div class="sidebar-widget-2 widget_search mb-50">
                        <div class="search-form">
                            <form action="{{ route('vendor.details', $store->id) }}" method="get">
                                <input id="search-store" type="text" name="search" placeholder="Search in this store..." />
            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We found <strong class="text-brand">{{ $store->products->count() }}</strong> items for you!
                        </p>
                    </div>
                        ...
                        <div class="vendor-info">
                            <ul class="font-sm mb-20">
                                <li><img class="mr-5"
                                        ...
                                        alt="" /><strong>Address: <strong>Address: </strong> <span>{{ $store->address }},
