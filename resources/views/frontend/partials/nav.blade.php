        ...
        <div class="header-action-icon-2">
            ...
            <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('user.track.orders') }}"><i class="fi fi-rs-location-alt mr-10"></i>Track
                            Order</a>
                    </li>
                    <li>
                        <a href="{{ route('user.orders') }}"><i class="fi fi-rs-label mr-10"></i>My Orders</a>
                    </li>
                    <li>
    ...
    <div class="header-action-icon-2">
        ...
        <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
            <ul>
                ...
                <li><a href="{{ route('register') }}"><i class="fi fi-rs-user-add mr-10"></i>Register</a></li>
            </ul>
        </div>
    </div>
@endif
