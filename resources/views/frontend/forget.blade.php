                            ...
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="post" action="{{ route('user.forget') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control" name="email" value="{{ $email  }}" readonly required autocomplete="email" autofocus placeholder="Enter your email">
                                    </div>

                                    <div class="login_footer form-group">
                                        <div class="chek-form">
                                            <input type="text" class=" @error('otp') is-invalid @enderror" required="" name="otp" placeholder="     Code *" />
                                            @error('otp')
                        ...
                        <div class="login_wrap widget-taber-content background-white">
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="post" action="{{ route('user.forget.otp') }}">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-heading btn-block hover-up" name="login">Send OTP</button>
                                    </div>
                                </form>
                            </div>
                        </div>
