    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row product-grid">
                ...
                @forelse( $storeWiseProduct as $item )
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{route('cartById', $item->id)}}">{{$item->store->name}}</a></span>
                            </div>
                            <div class="product-card-bottom">
                                ...
                                <div class="add-cart">
                                    <a class="add" href="{{route('cartById', $item->id)}}"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                </div>
                            </div>
                        </div>
                    </div>
