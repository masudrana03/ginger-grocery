                                        ...
                                        <div class="tab-pane fade show active" id="Description">
                                            <div class="">
                                                ...
                                                <ul class="product-more-infor mt-30">
                                                    <li><span>Attributes</span> {{ $product->attributes ?? 'Not found' }} </li>
                                                    <li><span>Calories Per Serving</span> {{ $product->calories_per_serving ?? 'Not found'}} </li>
                                                    <li><span>Fat Calories Per Serving</span> {{ $product->fat_calories_per_serving ?? 'Not found' }} </li>
                                                    <li><span>Brand</span> {{ $product->brand->name ? $product->brand->name : 'Not found' }} </li>
                                                    <li><span>Category</span> {{ $product->category->name ?? 'Not found' }} </li>
                                                    <li><span>Type</span> {{  count($product->types) > 0 ? $product->types->pluck('name')->implode(', ') : 'Not found'  }} </li>
                                                    <li><span>Unit</span> {{ $product->unit->name  ?? 'Not found' }} </li>
                                                    <li><span>Nutrition</span> {{ count($product->nutritions) > 0 ? $product->nutritions->pluck('name')->implode(', ') : 'Not found'}} </li>
                                                </ul>
