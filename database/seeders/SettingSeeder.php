...
class SettingSeeder extends Seeder {
     ...
     */
    public function run() {
        Setting::create( ['key' => 'company_name', 'value' => 'Metro Grocery'] );
        ...
        Setting::create( ['key' => 'mail_from_name', 'value' => 'Metro Grocery'] );
        ...
        Setting::create( ['key' => 'news_flash_one', 'value' => 'Welcome to Metro Grocery'] );
